...
use LaborDigital\T3faExample\Domain\Model\Faq\FaqItem;
use LaborDigital\T3faExample\Domain\Repository\Faq\FaqItemRepository;

class FaqItemResource implements ResourceInterface
{
    /**
     * @var \LaborDigital\T3faExample\Domain\Repository\Faq\FaqItemRepository
     */
    ...
    {
        $configurator->registerClass(FaqItem::class);
    }
